...
?>
    <aside>
        <ul class="nav">
            ...
            <li <?php echo in_array($current_page, $personals) ? 'class="active"' : '' ?> id="<?php echo isset($spe_hidden) ? $spe_hidden : '';?>">
            ...
            <li>
                ...
                <ul id="manger-posts" class="collapse">
                    <li id="<?php echo isset($spe_hidden) ? $spe_hidden : '';?>"><a href="#">已除稿件</a></li>
                    <li><a href="#">待审稿件</a></li>
                    <li><a href="#">已审稿件</a></li>
                    <li><a href="#">已退稿件</a></li>
                </ul>
